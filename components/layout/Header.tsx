...
export function Header({ settings }: HeaderProps) {
  ...
  return (
    <>
      ...
      {/* Fullscreen Backdrop & Mobile Navigation Drawer */}
      {isMobileMenuOpen && (
        <>
          {/* Dimmed backdrop blur overlay covering page behind drawer */}
          <div
            className="lg:hidden fixed inset-0 z-40 bg-brand-950/70 backdrop-blur-md transition-opacity animate-in fade-in duration-200"
