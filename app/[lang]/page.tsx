...
export default async function HomePage({ params }: HomePageProps) {
  ...
  return (
    <div className="space-y-14 sm:space-y-28 py-4 sm:py-6">
      {/* 1. HERO SECTION */}
      <section className="relative overflow-hidden bg-gradient-to-b from-brand-900 via-brand-800 to-brand-950 text-cream-100 py-12 sm:py-24 px-4 sm:px-8 rounded-2xl sm:rounded-3xl mx-2 sm:mx-8 border border-gold-500/30 shadow-2xl">
        ...
        <Container size="md" className="relative z-10 text-center px-2 sm:px-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gold-500/20 border border-gold-400/40 text-gold-300 text-xs sm:text-sm font-semibold tracking-wide uppercase mb-4 sm:mb-6 shadow-sm">
        ...
        <Container size="lg">
          <div className="bg-white p-5 sm:p-12 rounded-2xl sm:rounded-3xl border border-gold-300/30 shadow-soft grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
              <div className="p-4 sm:p-6 rounded-2xl bg-cream-50 border border-gold-300/30 text-center space-y-1">
          ...
          <Container size="lg">
                  ...
                  <Card key={service.id} hoverEffect glass className="flex flex-col justify-between">
                    <div>
                      <div className="h-44 sm:h-48 bg-gradient-to-tr from-brand-900 to-brand-800 flex items-center justify-center text-gold-300 p-4 sm:p-6 relative overflow-hidden">
                        ...
                        <span className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-gold-500 text-brand-950 font-semibold text-[10px] sm:text-xs px-2.5 py-1 rounded-full uppercase tracking-wider">
                          {service.category}
                        </span>
                      </div>
            ...
            <div className="mt-8 sm:mt-10 text-center">
              <Link href={`/${locale}/services`}>
                <span className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-800 text-gold-300 hover:bg-brand-900 font-semibold text-xs sm:text-sm shadow-md transition-all">
                  ...
                  <Card key={item.id} hoverEffect className="flex flex-col justify-between">
                    <div>
                      <div className="h-44 sm:h-48 bg-gradient-to-tr from-earth-900 to-earth-800 flex items-center justify-center text-gold-300 p-4 sm:p-6 relative overflow-hidden">
                        ...
                        <span className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-emerald-700 text-white font-semibold text-[10px] sm:text-xs px-2.5 py-1 rounded-full uppercase tracking-wider">
          ...
          <Container size="lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
              {testimonials.map((testi) => {
                ...
                return (
                  <Card key={testi.id} hoverEffect className="p-5 sm:p-6 bg-white border-gold-300/30 flex flex-col justify-between">
                    <div className="space-y-3 sm:space-y-4">
      ...
      <section>
        <Container size="lg">
          <div className="bg-gradient-to-r from-brand-950 via-brand-900 to-brand-950 text-cream-100 p-6 sm:p-12 rounded-2xl sm:rounded-3xl border border-gold-500/40 text-center shadow-2xl space-y-4 sm:space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-gold-500/20 border border-gold-400/30 text-gold-300 text-xs font-semibold uppercase tracking-wider">
